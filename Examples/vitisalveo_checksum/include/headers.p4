...
const sc_path_type PYTH_TYPE_EMPTY   = 0;
const sc_path_type PYTH_TYPE_SCION   = 1;
const sc_path_type PYTH_TYPE_ONE_HOP = 2;
const sc_path_type PYTH_TYPE_EPIC    = 3;
const sc_path_type PYTH_TYPE_COLIBRI = 4;
...
#define SC_MAX_HOPS_PER_SEG 63
#define SC_HOP_FIELD_BITS (12 * 8)
