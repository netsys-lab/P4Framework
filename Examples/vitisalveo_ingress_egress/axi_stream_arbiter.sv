...
//Input 1: From Ingress path-Ingress Translator (priority)
//Input 2: Routed back packets from Egress path (AXIS switch with tdest=1)
//
//
//////////////////////////////////////////////////////////////////////////////////
(* dont_touch = "true" *)
module axi_stream_arbiter (
    ...
    always_comb begin
        ...
        case (current_state)
        //check valid data on arbiter inputs
            IDLE: begin
            ...
            //after sending each fragment check which input has more valid data
            //ensure not to miss last fragment
            WAIT_LAST_S1: begin
               if (s_axis_tvalid[0:0] ) begin
                   next_state = SEND_SLAVE1;
               end else if (s_axis_tvalid[1:1]) begin
    ...
    always_comb begin
        ...
        case (current_state)
            IDLE: begin
                ...
                //forward packets from ingress path
            SEND_SLAVE1: begin
                ...
                //forward routed back packets from Egress path
            SEND_SLAVE2: begin
